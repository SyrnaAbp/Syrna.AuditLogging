...
using Syrna.AuditLogging.MainDemo.Blazor.Server.Host.Menus;
        ...
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            ...
            if (!hostingEnvironment.IsDevelopment())
            {
                ...
                PreConfigure<OpenIddictServerBuilder>(x =>
                {
                    ...
                    //scope: 'offline_access openid profile role email phone AuditLogging',
                    x.RegisterScopes(
            ...
            Configure<AbpBundlingOptions>(options =>
            {
                ...
                options.StyleBundles.Configure(
                    ...
                    bundle =>
                    {
                        ...
                        bundle.AddFiles("/Syrna.AuditLogging.MainDemo.Blazor.Server.Host.styles.css");
                    }
                );
            });
